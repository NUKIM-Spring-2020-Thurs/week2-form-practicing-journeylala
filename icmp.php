...
<body>
    ...
    <form action="submit.php" method="POST">
        ...
        如何知道高大資管營?<br>
            FB粉專<input type="radio" name="information" value="socialmedia">
            海報傳單<input type="radio" name="information" value="poster">
            親朋好友<input type="radio" name="information" value="relative"><br>
